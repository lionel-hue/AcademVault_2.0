...
export default function ArticleCard({ article, onSave }) {
    ...
    return (
        <div 
            className="group relative bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl overflow-hidden hover:border-gray-700 hover:shadow-2xl hover:shadow-yellow-500/10 transition-all duration-300"
